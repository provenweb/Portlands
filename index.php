...
<html lang-"en">
  <head>
    ...
    <link rel="stylesheet" href="<?php bloginfo('template_directory');?>/css/jquery.mobile-1.0.1.min.css"/>
    <link rel="stylesheet" href="<?php bloginfo('template_directory');?>/css/app.css"/>
    <script src="<?php bloginfo('template_directory');?>/js/jquery-1.6.4.min.js"></script>
    <script src="<?php bloginfo('template_directory');?>/js/jquery.actual.min.js"></script>
    <script src="<?php bloginfo('template_directory');?>/js/jquery.mobile-1.0.1.min.js"></script>
    <script src="<?php bloginfo('template_directory');?>/js/iscroll-watusi.js"></script>
    <script src="<?php bloginfo('template_directory');?>/js/jquery.mobile.iscrollview.js"></script>
    <script type="text/javascript" src="phonegap.js"></script>
	<script type="text/javascript" src="<?php bloginfo('template_directory');?>/js/app.js"></script>

	<style type="text/css">.ui-page { background-image:url(<?php background_image();?>); }</style>
	<style type="text/css">#homepagelogo,#latestheader li { background-color:#<?=get_background_color()?> !important; background-image: -webkit-linear-gradient(<?=getHexUpper()?>,<?=getHexLower()?>) !important;}</style>
	<style type="text/css">#nav #indicator li.active { background:#<?=get_background_color()?> !important; }</style>
  ...
  <body>
    <div id="homepage" data-role="page" data-dom-cache="true">
      ...
      <div id="homepagecontent" data-role="content" data-iscroll>
		...
		<div id="homepagelogo">
			<img src="icons/parklands.png" width="288" style="margin-top:10px;">
		</div>
